...
<html><head>
	...
	<center>
		<p style="font-size: 15px;"><b>LAPORAN PENGELUARAN OBAT</b></p>
	...
	<table style="font-size: 9px;" align="center" border="1" cellpadding="0" cellspacing="0">
		...
		<?php 
			...
			$no = 1;
			foreach ($pengeluaran as $ob): ?>
			<tr align="center">
				<td> <?php echo $no++; ?></td>
				<td> <?php echo $ob->tanggal_pengeluaran ?></td>
				<td> <?php echo $ob->id_obat ?></td>
				<td> <?php echo "Rp. ".$ob->harga_obat ?></td>
				<td> <?php echo $ob->stok_obat ?></td>
				<td> <?php echo "Rp. ".$ob->biaya_masuk ?></td>
			</tr>
		<?php endforeach; ?>
		<tr>
			<td colspan="5" align="right"><b>TOTAL BIAYA MASUK</b></td>
			<td align="center">
